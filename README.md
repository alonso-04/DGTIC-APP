...
1. **Configuramos el entorno de python:**
...
2. **Configuración para la base de datos:**

Hay que tener para esto se necesita tener instalado XAMPP, utilizar el archivo que está ubicado en `src/infraestructura/base_datos/estructura_bd.sql`, para poder cargarlo en el gestor de base de datos<br> 
...
Situandose en la carpeta `src` ejecutamos el siguiente comando: `python main.py` e iniciamos sesión con el usuario y contraseña que se estableció por defecto en el `.env` que crearon<br>
